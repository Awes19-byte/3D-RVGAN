...
class DepthwiseConv3D(Conv3D):
    ...
    def call(self, inputs, training=None):
        inputs = inputs, self.data_format
    ...
    def compute_output_shape(self, input_shape):
        ...
        depth = (depth - self.kernel_size[0]+ self.padding )/ self.strides[0]

        rows = (depth - self.kernel_size[1]+ self.padding )/ self.strides[1]

        cols = (depth - self.kernel_size[2]+ self.padding )/ self.strides[2]
